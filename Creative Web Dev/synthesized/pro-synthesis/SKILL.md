...
👉 [Terminology & Anti-Synonyms](references/terminology.md)
...
👉 **Reference Context**: 
- [Motion & Scroll Choreography](references/motion-and-scroll.md)
...
👉 **Reference Context**: 
- [Canvas & Particles](references/canvas-and-particles.md)
...
👉 **Reference Context**: 
- [Three.js & R3F](references/threejs-and-r3f.md)
- [Shaders & GLSL](references/shaders-and-glsl.md)
...
👉 **Reference Context**: 
- [Hybrid 3D Cinematics](references/hybrid-3d-cinematics.md)
...
👉 **Reference Context**: 
- [Performance & Profiling](references/performance-and-profiling.md)
