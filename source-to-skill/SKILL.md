...
description: |
  Compile source materials into an operational agent skill.
  Sources: transcripts, documents, PDFs, web content, video notes, books.
  Use when given raw knowledge sources to: extract methodology, produce a skill,
  build a teaching package, or turn documentation into agent capabilities.
  Triggers: create skill from, extract methodology, learn from, compile sources,
  source to skill, make a skill from this, turn into a skill.
---
