...
description: |
  Engineer knowledge-based expert systems using the CommonKADS methodology
  and MYCIN/EMYCIN implementation patterns. Full lifecycle: suitability
  assessment, organizational scoping, task analysis, knowledge acquisition,
  conceptual modeling (domain/inference/task layers), knowledge representation,
  rule engineering, certainty factors, inference design, static verification,
  explanation facilities, and structure-preserving system design.
  Triggers: build expert system, knowledge engineering, rule-based system,
  design inference engine, certainty factors, knowledge acquisition,
  CommonKADS, MYCIN methodology, backward chaining, knowledge model,
  verify knowledge base, explanation subsystem, task template.
---
