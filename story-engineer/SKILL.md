...
name: story-engineer
description: |
  Engineer compelling, non-generic narrative structures for websites, case studies,
  interactive experiences, and brand stories. Use when transforming raw project facts,
  case studies, creative briefs, or product histories into cinematic, dramatic story arcs.
  Prevents conventional section bloat (Hero-About-Services) by establishing narrative tension,
  question-answer chains, emotional modulation, and visual metaphors before visual/code design.
  Triggers: story engineering, narrative engine, write website story, creative narrative,
  case study story, dramatic arc, interactive story structure, story-first design.
---
